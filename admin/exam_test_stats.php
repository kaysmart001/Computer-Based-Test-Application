                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>  
                                            <a href="exam_test_chart.php?ass=<?php echo $ass_id; ?>&ts=<?php echo $tests['id'] ?>" ><button class="btn btn-default btn-xs"><i class="fa fa-bar-chart-o"></i> View Chart  </button> </a>                                                                                            
                                        </td>
<!--                                        <td>  
